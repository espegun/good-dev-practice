...
`$ git log` This will show the history of commits up to HEAD (scroll with arrow, quit with q). Add `--all` to see all commits (including later than HEAD). Add e.g. `-3` to see the latest 3.<br/>
